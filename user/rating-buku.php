...
if (isset($_POST['kirim'])) {
	...
	$query = mysqli_query($conn, "INSERT INTO tb_ulasan VALUES (
		'',
		'" . $_GET['kd_buku'] . "',
		'" . $_COOKIE['id'] . "',
		'" . $ulasan . "',
	...
	if ($query) {
		...
		echo "<script>window.location = 'data-kembali.php'</script>";
	} else {
...
<body>
	...
	<div class="wrapper">
		...
		<form action="" method="POST">
			...
			<textarea name="ulasan" cols="30" rows="5" placeholder="Your opinion..." required></textarea>
			<div class="btn-group">
				<button type="submit" name="kirim" class="btn submit">Submit</button>
